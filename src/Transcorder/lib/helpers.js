...
const makeRandomID = () => `_${Math.random().toString(36).substr(2, 12)}`;
...
// file media info
async function getMediaInfo(location) {
    let execRes = null;
...
// save object to json
function saveJsonObjToFile(obj, filePath) {
...
exports.saveJsonObjToFile = saveJsonObjToFile;
